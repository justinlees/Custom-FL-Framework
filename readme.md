...
## Privacy Guarentee Check

Performs gradient inversion attack to reconstruct the image with and without privacy. This shows the visualization of privacy guarentee and also calculates the MSE(Mean Square Error) which shows how much it has deviated from original values.
